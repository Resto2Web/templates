...
class TemplatesServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            /*$this->publishes([
                __DIR__.'/../resources/views' => resource_path('views/vendor/templates'),
            ], 'views');*/
            ...
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/templates'),
            ], 'lang');*/
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/config.php', 'templates');
